...
/*
 * to-wackowiki - an HTML to WackoWiki converter
 * 
 * Copyright 2017, Vladislav Janvarev
 * Copyright 2011-15, Dom Christie (to-markdown)
...
module.exports = [
...

  {
    ...
    replacement: function(content, node) {
      ...
      return '(('+node.getAttribute('href') + ' ' + content + '))';
    }
  },
